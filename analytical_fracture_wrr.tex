...
\authors{
J. Brezina\affil{1},
P. Burda\affil{2}\thanks{pavel.burda@fs.cvut.cz}
}


\affiliation{1}{Technical University of Liberec, Czech Republic}
\affiliation{2}{Czech Technical University, Prague, Czech Republic}
...
\correspondingauthor{Jan Brezina}{jan.brezina@tul.cz}
